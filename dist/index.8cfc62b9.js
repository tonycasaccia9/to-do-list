...
const generateMarkup = function(obj) {
  ...
  <button class="remove__item">\xd7</button>
...
const removeItem = function(index, obj) {
    ...
    const localStorageIndex = localStorageArr.findIndex((item)=>JSON.stringify(item) === JSON.stringify(obj));
...
listContainer.addEventListener("click", function(e) {
    ...
    const index = Array.from(list.children).findIndex((li)=>li.querySelector(".item__text").textContent === item.querySelector(".item__text").textContent);
    console.log(index);
